...
export const defaultProjectData = [
  {
    ...
    description: 'An app to help authors create and organize books they are currently writing and to connect authors to other aspiring authors.',
