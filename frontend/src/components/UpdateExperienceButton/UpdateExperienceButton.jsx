...
// import { thunk_updateProject } from "../../store/thunks/projects.jsx";





const UpdateExperienceButton = ({ experienceId }) => {
  const dispatch = useDispatch();
  // const prevInfo = useSelector(store => store.projectsReducer.projects[experienceId]);
  ...
  const onSubmit = event => {
    ...
    // dispatch(thunk_updateProject(experienceId, payload));
  }
